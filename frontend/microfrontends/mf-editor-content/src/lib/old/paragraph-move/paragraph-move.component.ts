...
import {ContentService, ContentServiceIntf} from "../store/content.service";
...
export class ParagraphMoveComponent implements OnInit {
  ...
  constructor(idService: IdService, private textService: ContentServiceIntf, private store: Store) {
